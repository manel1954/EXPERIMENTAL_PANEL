...
btn_bt_activado = tk.Button(frame_bluetooth, text="Bluetooth Desactivado Click para ACTIVARLO",
...
btn_bt_desactivado = tk.Button(frame_bluetooth, text="Bluetooth Activado Click para DESACTIVARLO ",
